...
var SagaIntegratifonTester = function () {
    function SagaIntegratifonTester(_ref) {
        var _this = this;
        ...
        (0, _classCallCheck3.default)(this, SagaIntegratifonTester);
    ...
    (0, _createClass3.default)(SagaIntegratifonTester, [{
        ...
        value: function run() {
            ...
            return this.start.apply(this, [sagas].concat(args)).done;
        }
    }, {
        key: 'start',
        value: function start() {
            ...
            task.toPromise().then(function () {
                return _this4._verifyAwaitedActionsCalled();
            });
            task.toPromise().catch(function (e) {
    ...
    return SagaIntegratifonTester;
}();

exports.default = SagaIntegratifonTester;
